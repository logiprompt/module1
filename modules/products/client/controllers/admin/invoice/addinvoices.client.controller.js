(function () {
  ...
  angular
    .module('products')
    .controller('AddinvoicesController', AddinvoicesController);
    AddinvoicesController.$inject = ['$scope','$http','$state','$stateParams'];
  function AddinvoicesController ($scope, $http, $state) {
   //alert(); 
   $scope.formdata = {};
