...
exports.updateCategory = function (req, res, next) {
    ...
    upload(req, res, function (err) {
        ...
        var data = {};
        cmsCategory.findById(userId).exec(function (err, data) {
            ...
            if (err) {
                ...
                if (picpath == '') {
                        ...
                        data.category_metadesc = reqBody.category_metadesc,
                        data.category_metakey = reqBody.category_metakey,
                        data.menu = reqBody.menu,
                ...
                cmsCategory.update({ '_id': userId }, { $set: data }, function (err, output) {
                    if (err) 
                    {
