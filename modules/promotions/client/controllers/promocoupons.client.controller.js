(function () {
  ...
  angular
    .module('products')
    .controller('PromocouponController', PromocouponController);
    PromocouponController.$inject = ['$scope','$http','$state','$stateParams'];
  function PromocouponController ($scope, $http, $state) {
...
$scope.formdata.sale='0';
$scope.formdata.category='0';
$scope.formdata.con='0';
...
console.log(checkedValue[0])
  ...
  $scope.editpage[0].removeAttribute("href");
    ...
    $scope.editpage[0].setAttribute("href", "/promotions/editcoupons/"+linkid);
  }
