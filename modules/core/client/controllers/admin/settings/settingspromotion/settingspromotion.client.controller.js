(function () {
  ...
  angular
    .module('core')
    .controller('Settingspromotion', Settingspromotion);



    Settingspromotion.$inject = ['$scope','$http','$state','$stateParams', 'Upload'];

  function Settingspromotion ($scope, $http, $state, $stateParams, Upload) {
