(function () {
  ...
  angular
    .module('core')
    .controller('Settingsnewsletter', Settingsnewsletter);



    Settingsnewsletter.$inject = ['$scope','$http','$state','$stateParams', 'Upload'];

  function Settingsnewsletter ($scope, $http, $state, $stateParams, Upload) {
