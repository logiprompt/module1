(function () {
  ...
  angular
    .module('core')
    .controller('Editsettingsmenu', Editsettingsmenu);



    Editsettingsmenu.$inject = ['$scope', '$http', '$state', '$stateParams', 'Upload', 'adminMenuService'];

  function Editsettingsmenu($scope, $http, $state, $stateParams, Upload, adminMenuService) {
