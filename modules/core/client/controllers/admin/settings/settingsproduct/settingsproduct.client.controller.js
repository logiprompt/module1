(function () {
  ...
  angular
    .module('core')
    .controller('Settingsproduct', Settingsproduct);



    Settingsproduct.$inject = ['$scope','$http','$state','$stateParams', 'Upload'];

  function Settingsproduct ($scope, $http, $state, $stateParams, Upload) {
