(function () {
  ...
  angular
    .module('core')
    .controller('Settingsmembership', Settingsmembership);



    Settingsmembership.$inject = ['$scope','$http','$state','$stateParams', 'Upload'];

  function Settingsmembership ($scope, $http, $state, $stateParams, Upload) {
