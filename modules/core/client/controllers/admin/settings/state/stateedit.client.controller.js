(function () {
  ...
  angular
    .module('core')
    .controller('Stateedit', Stateedit);



    Stateedit.$inject = ['$scope','$http','$state','$stateParams','$httpParamSerializer', 'Upload'];

  function Stateedit ($scope, $http, $state, $stateParams,$httpParamSerializer, Upload) {
...
////////////////////////////////////////////////////////////////////
/////////////////////////edit role/////////////////////////////////////////////////////////////////
var stateid={id: $stateParams.id};
 $http({
  url: '/api/admin/viewStatebyid',
  method: "POST",
  data:stateid
})
.then(function(response) {
...
function(response) { 
 ...
 {
  var data={'id':$stateParams.id,'country':$scope.formdata.country,'state':$scope.formdata.state,'status':$scope.formdata.status,'username':$scope.formdata.username,'ip':$scope.formdata.ip}
   //console.log(data);
   if($scope.validation()==0){
      $http({
           url: '/api/admin/updateState',
           method: "POST",
           data:data
       })
       .then(function(response) {
         ...
         {
            swal("Sccess!", "Successfully State updated!", "success");
          $state.reload();
         }
