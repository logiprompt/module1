(function () {
  ...
  angular
    .module('core')
    .controller('Offlinevendor', Offlinevendor);



    Offlinevendor.$inject = ['$scope','$http','$state','$stateParams', 'Upload'];

  function Offlinevendor ($scope, $http, $state, $stateParams, Upload) {
