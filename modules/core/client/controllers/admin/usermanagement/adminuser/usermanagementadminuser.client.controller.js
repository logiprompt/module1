...
///////////////////////////////////insert ////////////////////////////////////////////////////
 ...
 $scope.insadminuser=function(){
  ...
  $scope.chkrollValue=[];
  var checkedrollValue = document.querySelectorAll('.rowrollchk:checked');
  for(var i=0;i<checkedrollValue.length;i++){
    $scope.chkrollValue.push(checkedrollValue[i].value); 
  }
$scope.formdata.roll=$scope.chkrollValue;
 ...
 if($scope.formdata.cpassword=='' || angular.isUndefined($scope.formdata.cpassword) ){
               ...
               if($scope.formdata.roll=='' || angular.isUndefined($scope.formdata.roll) ){
