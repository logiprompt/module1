(function () {
  ...
  angular
    ...
    EmailreviewsubmissionController.$inject = ['$scope','$http','$state','$stateParams', 'Upload'];

  function EmailreviewsubmissionController ($scope, $http, $state, $stateParams, Upload) {
