(function () {
  ...
  angular
    ...
    EmailcmstagsubmissionController.$inject = ['$scope','$http','$state','$stateParams', 'Upload'];

  function EmailcmstagsubmissionController ($scope, $http, $state, $stateParams, Upload) {
