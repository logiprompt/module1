(function () {
  ...
  angular
    .module('core')
    .controller('EditCmsreviewsubmissionController', EditCmsreviewsubmissionController);



    EditCmsreviewsubmissionController.$inject = ['$scope','$http','$state','$stateParams', 'Upload','cmsreviewsubmissionService'];

  function EditCmsreviewsubmissionController ($scope, $http, $state, $stateParams, Upload, cmsreviewsubmissionService) {
 ...
 // console.log($scope.currentLan)
  ...
  $scope.defaultLang=localStorage.getItem('defaultLang').toString();
    ...
    $scope.getCmsreviewSubmissionById = function (userId) {
    //  console.log(0);
      $scope.cmsreviewsubmissionService.getCmsreviewSubmissionById(userId).then(function (result) {
       // console.log(userId);
         //console.log(result);
    ...
    $scope.getCmsreviewSubmissionById($stateParams.id);
...
///////////////////////////////////////////////////////////////
    ...
    /*
     *
     *  Function : update ReviewSubmition
     * Description : Update ReviewSubmition details
     * Owner : anju
     * 
     */

    $scope.updateReviewSubmition = function () {
      ...
      if ($scope.formdata.$valid && $scope.status != 0) {
        ...
        $scope.cmsreviewsubmissionService.updateReviewSubmition($stateParams.id, data).then(function (result) {
         // console.log(result);
          if (result.statusText = "OK") {
            swal("Sccess!", "Successfully updated ", "success");
            //$state.reload();
            $state.go('emailcmsreviewsubmission');
          }
        });
      }
    }
